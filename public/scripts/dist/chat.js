...
//@ts-ignore
var socket = io();
var messages = document.querySelector('.messageContainer__list');
var username = handleGetUser();
console.dir(username.PromiseResult);
function handleGetUser() {
    return __awaiter(this, void 0, void 0, function () {
        var data, userDB, error, username_1, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (error)
                        throw error;
                    username_1 = userDB.username;
                    return [2 /*return*/, username_1];
                case 2:
                    error_1 = _a.sent();
